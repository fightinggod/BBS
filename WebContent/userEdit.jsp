		...
		<div class="shell">
			...
			<div id="navigation">
				<ul>
					...
					<li><a href="userList.html" class="active"><span>用户管理</span></a></li>
			...
			<div id="main">
				...
				<div id="content">
					...
					<div class="box">
						...
						<center>
						<form id="form1" name="form1" method="post" action="UserServlet?sign=edit"  >
							<table>
								<tr>
									<td><font color="#AD462D">用户名：</font></td>
									<td><input type="text" name="name" id="name" value="${user.username}" readonly="readonly"/>
										<input type="hidden" name="uid" value="${user.id}" /></td>
								</tr>
								<tr>
									<td><font color="#AD462D">密码：</font></td>
									<td><input type="password" name="pwd" id="pwd" value="${user.password}" /></td>
								</tr>
								<tr>
									<td><font color="#AD462D">确认密码：</font></td>
									<td><input type="password" name="pwd1" id="pwd1" value="${user.password}"/></td>
								</tr>
								<tr>
